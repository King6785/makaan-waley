        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Why WeHouse reason cards — staggered entrance
            var whyReasonCards = gsap.utils.toArray("#why-wehouse .why-reason-card");
            ...
            (function initTestimonialsAutoSlider() {
                ...
                function slideTo(index) {
                    ...
                    slides.forEach(function(slideEl, i) {
                        ...
                        slideEl.classList.toggle("shadow-orange-400/25", isActive);
                ...
                function enableNativeMobile() {
                    ...
                    slides.forEach(function(slideEl) {
                        slideEl.classList.remove("shadow-2xl", "shadow-orange-400/25", "z-10");
            ...
            function highlightCity(cityId, isHighlighted) {
                ...
                cityNames.forEach(function(n) {
                    if (n.getAttribute("data-city") === cityId) {
                        ...
                        n.classList.toggle("!border-amber-500", isHighlighted);
                        n.classList.toggle("!shadow-lg", isHighlighted);
                        n.classList.toggle("!shadow-amber-500/30", isHighlighted);
